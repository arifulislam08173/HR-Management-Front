...
const CreatePenalties = ({ isOpen, toggle, data }) => {
  ...
  return (
    <Dialog open={isOpen} onClose={toggle} sx={styles.dialog}>
      <DialogTitle sx={{ position: "relative",display: "flex",alignItems: "center",marginBottom: "24px" }}>
            <Avatar
                sx={{
        ...
        <Form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={{ marginTop: "15px", fontSize: "0.9rem", color: "#666" }}>
            <ol>
              ...
              <li>By default minus leave will cut/deduct from available leaves</li>
              <li>By enabling 'Deduct from carry forward' leave will cut/deduct from carry forward days</li>
            </ol>
          </div>
