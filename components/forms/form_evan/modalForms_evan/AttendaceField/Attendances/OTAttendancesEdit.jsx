...
const OTAttendancesEdit = ({ isOpen, toggle, data }) => {
  ...
  return (
    <Dialog open={isOpen} onClose={toggle} sx={styles.dialog}>
      <DialogTitle sx={{ position: "relative" }}>
        <span style={styles.title}>Edit OT Attendance</span>
      ...
      <DialogContent>
        <Form onSubmit={handleSubmit} style={styles.form}>
          ...
          <Row>
            ...
            {/* <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Over Time
...
export default OTAttendancesEdit;
