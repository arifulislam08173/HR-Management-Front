...
const EditAttendances = ({ isOpen, toggle, data }) => {
  ...
  return (
    <Dialog open={isOpen} onClose={toggle} sx={styles.dialog}>
      ...
      <span style={styles.title}>Edit Attendance</span>
        ...
        <Form onSubmit={handleSubmit} style={styles.form}>
          <Row>
            ...
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>
                    Attendance Date<span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span>
                </Label>
                <Input
                  type="date"
                  value={formData.date || ""}
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Shift
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="select"
                  name="shift"
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Check-In Date
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="date"
            ...
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Check-In
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="time"
                  name="checkIn"
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Check-Out Date
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="date"
            ...
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Check-Out
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="time"
                  name="checkOut"
          ...
          <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Worked hours
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="text"
                  name="atWork"
            ...
            <Col md={6}>
              <FormGroup>
                <Label style={{fontWeight:"bold"}}>Minimum Hours
                    <span style={{ color: "#dc3545", marginLeft: "4px" }}>*</span></Label>
                <Input
                  type="text"
                  name="minHour"
          ...
          <FormGroup>
            <Label style={{fontWeight:"bold", display: "block"}}>Validate Attendance?</Label>
            <Switch
