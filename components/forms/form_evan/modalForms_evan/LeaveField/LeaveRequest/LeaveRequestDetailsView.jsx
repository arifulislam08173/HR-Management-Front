...
import PenaltiesCreateForm from "./PenaltiesCreateForm";
        ...
        <DialogContent sx={styles.content}>
          ...
          <Box sx={styles.detailsSection}>
            ...
            <Box sx={styles.detailItem}>
              ...
              <Typography sx={styles.value}>{data?.createDate}</Typography>
            </Box>
            <Box sx={styles.detailItem}>
              <Typography sx={styles.label}>Created By</Typography>
              <Typography sx={styles.value}>{data?.createdBy}</Typography>
            </Box>
            <Box sx={styles.detailItem}>
...
export default LeaveRequestDetailsView;
