...
const RotatingshiftAssign = ({ isOpen, toggle }) => {
      ...
      <ModalBody style={styles.modalContent}>
        <Container fluid>
          <div style={styles.header}>
            <h5 style={styles.title}>Rotating Shift Assign</h5>
            <button
              onClick={toggle}
              ...
              <Col xs={12}>
                <FormGroup style={styles.formGroup}>
                  ...
                  <Input
                    ...
                    style={styles.input}
                  >
                    <option value="">-----Choose Rotating shift-----</option>
                    <option value="mtn">Morning to Night</option>
                    <option value="ntm">Night to Morning</option>
                  </Input>
                </FormGroup>
              </Col>
