...
const UpdateRotatingWorkType = ({ isOpen, toggle, data }) => {
  ...
  useEffect(() => {
    if (data) {
      setFormData({
        ...
        rotateAfterDay: data.rotateAfterDay,
      });
    }
  }, [data]);
  ...
  return (
    <Dialog open={isOpen} onClose={toggle} sx={styles.dialog}>
      <DialogTitle sx={{ position: "relative" }}>
        <span style={styles.title}>Rotating Work Type Update</span>
        ...
        <Form onSubmit={handleSubmit} style={styles.form}>
          ...
          <FormGroup>
            ...
            {/* <Input
              ...
              style={styles.input}
            >
              <option value="">{formData.rotateAfterDay}</option>
              <option value="">------</option>
...
export default UpdateRotatingWorkType
