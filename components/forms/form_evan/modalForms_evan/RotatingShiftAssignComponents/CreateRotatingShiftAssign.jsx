...
const CreateRotatingShiftAssign = ({ isOpen, toggle }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} size="lg">
      <div style={modalStyles.form}>
        ...
        <h5 style={modalStyles.title}>Rotating Shift Assign</h5>
        <hr />
            ...
            <Col md={12}>
              <FormGroup>
                ...
                <Input type="select" style={modalStyles.input}>
                  ...
                  <option>Night to Morning</option>
...
export default CreateRotatingShiftAssign;
