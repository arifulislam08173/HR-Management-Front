...
const DuplicateRotatingShift = ({ isOpen, toggle, data }) => {
    ...
    <Dialog open={isOpen} onClose={toggle} sx={styles.dialog}>
      ...
      <DialogContent>
        <Form onSubmit={handleSubmit} style={styles.form}>
            ...
            <Col md={12}>
              <FormGroup>
                ...
                <Input
                  type="select"
                  name="rotatingShift"
                  value={formData.rotatingShift}
                  onChange={handleChange}
                  style={styles.input}
                >
                  <option value={formData.rotatingShift} disabled>
                    {formData.rotatingShift}
                  </option>
                  {["Morning to Night", "Night to Morning"]
                    .filter((option) => option !== formData.rotatingShift)
                    .map((option) => (
          ...
          <FormGroup>
            <Label style={{ fontWeight: "bold" }}>Rotate Every</Label>
            <Input
              type="select"
              name="rotateEvery"
...
export default DuplicateRotatingShift;