...
const EditEmployee = () => {
  ...
  const navItems = ["Personal Info","Work Info", "Bank Info"];
            ...
            {activeTab === "Personal Info" ? (
              <>
                ...
                <Row>
                  <Col md={6}>
                    <FormGroup>
                      <Label style={{ fontWeight: "bolder" }} for="badgeid">
                        Badge Id
                      </Label>
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      <Label style={{ fontWeight: "bolder" }} for="experience">
                        Experience
                      </Label>
                      <Input
                        type="number"
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      <Label style={{ fontWeight: "bolder" }} for="contactName">
