...
const purchaseVatGoods = ({ token }) => {
  ...
  const [branch_from, setBranchFrom] = useState(0);
    ...
    <>
      ...
      <div className="row">
        {/* <div className="col-md-4">
          <h6 className="text-secondary">Branches meew</h6>
          <TextField
          ...
          <div ref={printRef} className="p-5">
            ...
            <div className="mt-4">
              ...
              >
                <thead>
                  <tr>
                    <th colSpan={29} className="text-center align-middle">
                    ...
                    <tr key={index}>
                      ...
                      {mushak.type == "credit" ? (
                        <>
                          ...
                          <th>{mushak.qty + mushak.opening_qty}</th>
                          {mushak.average_price == 0 ? (
                            <th>
                              {(
                                (mushak.qty + mushak.opening_qty) *
                                mushak.price
                              ).toFixed(2)}
                            </th>
                          ) : (
                        ...
                        <>
                          ...
                          {mushak.type == "credit" ? (
                            ...
                            <>
                              ...
                              {mushak.average_price == 0 ? (
                                <th>
                                  {(mushak.opening_qty * mushak.price).toFixed(
                                    2
                                  )}
                                </th>
                              ) : (
...
export default connect(mapStateToProps)(purchaseVatGoods);
