        ...
        if (response.data.status) {
          const data = response.data.data.map((stock, index) => {
            return {
              ...
              Name: stock.title,
              SKU: stock.sku,
              Opening: stock.opening_qty.toFixed(2),
              Production: stock.totalStockInProduction.toFixed(2),
