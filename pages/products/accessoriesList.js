    ...
    await axios
      ...
      .then((response) => {
        if (response.data.status) {
          ...
          console.log(apiProductDownload, data);
          const fileName = "Accesories_List";
    ...
    <>
      <div className="row">
        ...
        <div className="col-md-6 mt-1 mb-3">
          ...
          >
            <Button variant="outlined" size="large">Create Product</Button>
          </Link>
        </div>
      </div>
      <div className="row">
              ...
              <tbody>
                {products?.map((product, index) => (
                  <tr key={index}>
                    ...
                    {/* <td>
                      <img
                        src={`${BASE_URL}storage/thumbnails/${product.photo}`}
                        alt="No Image"
                        height={50}
                      />
                    </td> */}
