...
const SalesBranchReport = ({ token, company }) => {
  ...
  const generateOrders = () => {
    setLoader(true);
    const apiOrderSearch = BASE_URL + "api/v1/sales/product-statement";
  ...
  const generatePdf = () => {
    ...
    doc.autoTable({
      head: [["Product Name", "Product SKU", "Qunatity", "Value", "SD", "VAT"]],
...
export default connect(mapStateToProps)(SalesBranchReport);
