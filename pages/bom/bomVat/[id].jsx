        ...
        <>
          ...
          <div ref={printRef} className="p-5">
            ...
            <div>
              <div className="row">
                ...
                <div className="col-md-4 text-center">
                  ...
                  <div className="row">
                    <b style={{ color: "dodgerblue" }}>[As per rule 21]</b>
                  </div>
                </div>
                <div className="col-md-4 text-end">
                  <b style={{ color: "darkviolet" }}>Mushak 4.3</b>
                </div>
              </div>
              ...
              <div className="row ">
                <b>
                  1st Delivery date of goods/ service as per declared
                  input-output coefficient -
                </b>
              </div>
            </div>
                ...
                <thead>
                  <tr>
                    ...
                    <th className="text-center align-middle" colSpan={5}>
                      Details of usable materials/ raw materials and packing
                      items, quantity and purchase price per unit of supply
                      (including material wise depreciation rate)
                    </th>
                  ...
                  <tr>
                    <th className="text-center align-middle">Particulars</th>
                    <th className="text-center align-middle">
                      Quantity including Wastage
                    </th>
                    <th className="text-center align-middle">Purchase Price</th>
                    <th className="text-center align-middle">Wastage</th>
                    <th className="text-center align-middle">in %</th>
                    <th className="text-center align-middle">
            ...
            <div>
              ...
              <div className="row ">
                <div className="col-md-12 mt-1">
                  <b>4.</b> In case of supply of goods by a registered person /
                  organization, the gross value shall be stated in a single
                  figure in column (11), with the words "Particulars of Value
                  Addition" mentioned in column (10). That is, in this case, the
                  value addition sector should not be mentioned separately.
                </div>
              </div>
            </div>
          </div>
...
BomVat.getInitialProps = async ({ query }) => {
  return {
    query,
  };
};
...
export default connect(mapStateToProps)(BomVat);
